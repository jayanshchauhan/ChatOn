...
import com.jayansh.chaton.ChatAdapter
import com.jayansh.chaton.Inbox
import com.jayansh.chaton.User
import com.jayansh.chaton.KeyboardVisibilityUtil
import com.jayansh.chaton.isSameDayAs
...
class ChatActivity : AppCompatActivity() {
    ...
    private val db: FirebaseDatabase by lazy {
        FirebaseDatabase.getInstance("https://chaton-22d82-default-rtdb.firebaseio.com/")
    }
    ...
    fun clickk(view: View) {
        val i =Intent(this,ChatsFragment::class.java)
        startActivity(i)
    }
}